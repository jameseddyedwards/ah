...
?>
	...
	<?php if (have_comments()) : ?>
		<h2 id="comments-title">
			<?php
				printf( _n( 'One thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', get_comments_number(), 'alastairhumphreys' ),
	...
	?>
		<p class="nocomments"><?php _e( 'Comments are closed.', 'alastairhumphreys' ); ?></p>
	<?php endif; ?>
