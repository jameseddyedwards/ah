	...
	<article id="post-<?php the_ID(); ?>" <?php post_class( 'indexed' ); ?>>
		<header class="entry-header">
			<hgroup>
				...
				<h3 class="entry-format"><?php _e( 'Image', 'alastairhumphreys' ); ?></h3>
			</hgroup>
		...
		<footer class="entry-meta">
			<div class="entry-meta">
				<?php
					printf( __( '<a href="%1$s" rel="bookmark"><time class="entry-date" datetime="%2$s" pubdate>%3$s</time></a><span class="by-author"> <span class="sep"> by </span> <span class="author vcard"><a class="url fn n" href="%4$s" title="%5$s" rel="author">%6$s</a></span></span>', 'alastairhumphreys' ),
			...
			<div class="entry-meta">
				...
				<span class="tag-links">
					<?php printf( __( '<span class="%1$s">Tagged</span> %2$s', 'alastairhumphreys' ), 'entry-utility-prep entry-utility-prep-tag-links', $tags_list ); ?>
				</span>
				<?php endif; // End if $tags_list ?>

				<?php if ( comments_open() ) : ?>
				<span class="comments-link"><?php comments_popup_link( '<span class="leave-reply">' . __( 'Reply', 'alastairhumphreys' ) . '</span>', __( '<strong>1</strong> Reply', 'alastairhumphreys' ), __( '<strong>%</strong> Replies', 'alastairhumphreys' ) ); ?></span>
